...
<body>
    ...
    <center>
        <table>
            <tr>
                <th colspan="2"><a>Vozaci Mercedesa i Red Bulla</a></th>
            </tr>
            <th>Ime</th>
            <th>Prezime</th>
            </tr>
            <?php
            $sql_query = "SELECT Ime, Prezime FROM vozaci WHERE Tim = 'Mercedes'
            UNION
            SELECT Ime, Prezime FROM vozaci WHERE Tim = 'Red Bull Racing'";
