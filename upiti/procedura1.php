...
if (isset($_POST['execute'])) {
    ...
    if ($team != null) {
        ...
        $sql_query = "CALL GetDriverInfo('$team')";
    ...
    <div id="navbar">
        <div id="header">
            <a href="../index.php" style="text-decoration: none; color: white;">
                <label>F1 Sezona | Procedura 1</label>
            </a>
        </div>
        <div id="buttons">
    ...
    <center>
        <div class="">
            <form method="post" action="" id="formid">
                <input type="text" id="team_id" name="team" placeholder="Unesi ime tima">
                <button type="submit" name="execute">Izvrsi</button>
            </form>
            <table id="tableid">
                <tr>
                    <th colspan="2"><a>Vozaci tima
                            <?php if (isset($team) && $team != null):
                                echo $team;
                                print "-a";
                            endif;
                            ?>
