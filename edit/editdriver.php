...
if (isset($_GET['edit_id'])) {
    $sql_query = "SELECT * FROM driver_standings WHERE id=" . $_GET['edit_id'];
...
if (isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE driver_standings SET Broj_vozaca='$Broj_vozaca',Broj_poena='$Broj_poena' WHERE id=" . $_GET['edit_id'];

    if (mysqli_query($conn, $sql_query)) {
        ?>
        <script type="text/javascript">
            alert('Promena je uspesno sacuvana!');
            window.location.href = '../datatables/driverstandings.php';
        </script>
        <?php
    } else {
        ?>
...
<body>
    <div id="navbar">
        <div id="header">
            <a href="../datatables/driverstandings.php" style="text-decoration: none; color: white;">
        ...
        <div class="tableinsert">
            <div id="content">
                <form method="post">
                    <table align="center">
                        <tr>
                            <td><input type="text" name="Broj_vozaca" placeholder="ID Vozaca"
                                    value="<?php echo $fetched_row['Broj_vozaca']; ?>" required /></td>
                        </tr>
                        <tr>
