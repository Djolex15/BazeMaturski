...
if (isset($_SESSION['role'])) {
    ...
    if (isset($_GET['edit_id'])) {
        $sql_query = "SELECT * FROM vozaci WHERE id=" . $_GET['edit_id'];
    ...
    if (isset($_POST['btn-update'])) {
        ...
        $sql_query = "UPDATE vozaci SET Ime='$first_name',Prezime='$last_name',Trkacki_broj='$driver_number', Tim = '$team', Broj_sampionata = '$championships' WHERE id=" . $_GET['edit_id'];
        // sql query for update data into database
...
<body>
    <div id="navbar">
        <div id="header">
            <a href="../datatables/vozaci.php" style="text-decoration: none; color: white;">
        ...
        <div class="tableinsert">
            <div id="content">
                <form method="post">
                    <table align="center">
                        <tr>
                            <td><input type="text" name="first_name" placeholder="Ime"
                                    value="<?php echo $fetched_row['Ime']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="last_name" placeholder="Prezime"
                                    value="<?php echo $fetched_row['Prezime']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="driver_number" placeholder="Trkacki broj"
                                    value="<?php echo $fetched_row['Trkacki_broj']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="team" placeholder="Tim"
                                    value="<?php echo $fetched_row['Tim']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="championships" placeholder="Broj sampionata"
                                    value="<?php echo $fetched_row['Broj_sampionata']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td>
