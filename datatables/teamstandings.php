...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO team_standings (Tim, Broj_poena) VALUES ('$Tim', '$Broj_poena')";

    if (mysqli_query($conn, $sql_query)) {
        ?>
        <script type="text/javascript">
            alert('Podatak je sacuvan');
            window.location.href = 'teamstandings.php';
        </script>
        <?php
    } else {
        ?>
    ...
    <script type="text/javascript">
        function edt_id(id) {
            if (confirm('Sigurni ste da zelite promenu podataka?')) {
                window.location.href = '../edit/editteam.php?edit_id=' + id;
            }
        }
        function delete_id(id) {
            if (confirm('Da li sigurno zelite da obrisete podatak?')) {
                window.location.href = '../adminpage.php?deleteteam_id=' + id;
            }
        }
    </script>
</head>
...
<body>
    <div id="navbar">
        <div id="header">
            <a href="../adminpage.php" style="text-decoration: none; color: white;">
                <label>F1 Sezona | Team Standings Table</label>
            </a>
        </div>
        <div id="buttons">
    ...
    <center>
        ...
        <center>
            <table>
                <tr>
                    <th colspan="2"><a>Team Standings</a></th>
                </tr>
                <th>Tim</th>
                <th>Broj Poena</th>
                ...
                <?php
                $sql_query = "SELECT * FROM team_standings ORDER BY Broj_poena DESC";
                ...
                <div class="table" id="formContainer" style="display: none;">
                    <div id="content">
                        <form method="post">
                            ...
                            <table>
                                <tr>
                                    <td><input type="text" name="Tim" placeholder="ID Tima" required />
                                    </td>
                                </tr>
                                <tr>
