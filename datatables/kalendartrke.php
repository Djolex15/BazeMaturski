...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO kalendar_trke (Trka, Datum_odrzavanja) VALUES ('$Trka', '$Datum_odrzavanja')";

    if (mysqli_query($conn, $sql_query)) {
        ?>
        <script type="text/javascript">
            alert('Podatak je sacuvan');
            window.location.href = 'kalendartrke.php';
        </script>
        <?php
    } else {
        ?>
    ...
    <script type="text/javascript">
        function edt_id(id) {
            if (confirm('Sigurni ste da zelite promenu podataka?')) {
                window.location.href = '../edit/editkalendar.php?edit_id=' + id;
            }
        }
        function delete_id(id) {
            if (confirm('Da li sigurno zelite da obrisete podatak?')) {
                window.location.href = '../adminpage.php?deletekalendar_id=' + id;
            }
        }
    </script>
</head>
...
<body>
    <div id="navbar">
        <div id="header">
            <a href="../adminpage.php" style="text-decoration: none; color: white;">
                <label>F1 Sezona | Kalendar Trke Table</label>
            </a>
        </div>
        <div id="buttons">
    ...
    <center>
        ...
        <center>
            <table>
                <tr>
                    <th colspan="2"><a>Kalendar Trke</a></th>
                </tr>
                <th>Trka</th>
                ...
                <?php
                $sql_query = "SELECT * FROM kalendar_trke";
                ...
                <div class="table" id="formContainer" style="display: none;">
                    <div id="content">
                        <form method="post">
                            ...
                            <table>
                                <tr>
                                    <td><input type="text" name="Trka" placeholder="Trka" required />
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="text" name="Datum_odrzavanja"
                                            placeholder="Datum Odrzavanja (YYYY-MM-DD)" required /></td>
                                </tr>
                                <tr>
